...
- [Complete electron-updater HTTP example](https://gist.github.com/kbaks/0ff845e8e3f59dbe7eaf2bf24443f104)
...
**NOTE:** If you want to run through this whole process, either fork this repo or [start your own from a template](https://github.com/kbaks/electron-updater-example/generate). Then replace all instances of `kbaks` with your GitHub username before doing the following steps.
